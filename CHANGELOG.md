...
### Changed
- **BREAKING**: Repository renamed from `optivem/resolve-latest-docker-digests-action` to `optivem/inspect-docker-images-action`
...
- Users should update their workflow files to use the new repository name: `optivem/inspect-docker-images-action@v1`
...
[Unreleased]: https://github.com/optivem/inspect-docker-images-action/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/optivem/inspect-docker-images-action/releases/tag/v1.0.0